...
import (
	"fmt"
	"github.com/dinhtrung/smoking-counter/pkg/fiber/authjwt/consts"
	"github.com/dinhtrung/smoking-counter/pkg/fiber/authjwt/web/rest"
...
// SetupRoutes configure the route for application
...
func SetupAuthJWT(srv *fiber.App, jwtSecret string, skipcheck ...string) {
	...
	srv.Use(jwtware.New(jwtware.Config{
		...
		SigningKey: jwtware.SigningKey{Key: []byte(consts.JWTSECRET)},
	}))
}
